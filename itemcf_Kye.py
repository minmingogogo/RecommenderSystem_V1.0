...
#                print('file line :',line)
    ...
    def calc_movie_sim(self):
        ...
        movie_popular_df.to_excel('output_movie_popular.xlsx')
        print('output movie_popular.xlsx')
        ...
        #导出json
        with open(self.generateDataPath + '/'+ "output_itemsim_mat.json",'w') as f:
        ...
        with open(self.generateDataPath + '/'+ "output_item_popular.json",'w') as f:
            json.dump(self.movie_popular,f)
        print('finish dump output_itemsim_mat.json')
...
#    'D:\myGitHub\KYE_AI\ecomm\RecommenderSystem_V1.0\data\create_user_item_count.pkl'
    ratingfile = os.path.join('data', 'create_Dataframe_user_item_times_Merge.txt')
